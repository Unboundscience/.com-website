...
const stops = [
  ...
  },
  {
    ...
    tileId: 10,
    title: 'The Platform',
    subtitle: 'UNBOUND SCIENCE',
    text: 'A library of blueprints, instruction manuals, and how-to videos to replicate anything.',
    icon: '🏛️',
    color: '#8AEB75',
    features: ['Community Funding Pools', 'Distributed Storage', 'Dead-man Switches', 'Anonymous & Open Source'],
  },
  {
    id: 3,
    tileId: 14,
